...
for checkpoint_step in all_checkpoint_steps:
    ...
    g2.write(
        'python eval_qa.py --predict_file <location for saving prediction files>/{}predictions_valid.txt --eval_type qc '
        '--true_contexts ../dataset_2wiki_0.1/RD_Oracle/valid.source\n'.format(model_path + path_suffix))

    g3.write('echo {}\n'.format(checkpoint_step))
    g3.write('python eval_qa.py --predict_file <location for saving prediction files>/{}predictions_test.txt --eval_type qc '
             '--true_contexts ../dataset_2wiki_0.1/RD_Oracle/test.source\n'.format(model_path+path_suffix))
