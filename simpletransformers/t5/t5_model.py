...
class T5Model:
    ...
    def predict(self, pred_data, output_dir=None, suffix=None, verbose=True, silent=False):
        ...
        if self.args.use_multiprocessed_decoding:
            ...
            outputs = [
                self.tokenizer.decode(output_id, skip_special_tokens=False, clean_up_tokenization_spaces=False)
    ...
    def _decode(self, output_id):
        return self.tokenizer.decode(output_id, skip_special_tokens=False, clean_up_tokenization_spaces=False)
