...
class BartForConditionalGeneration(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig):
        ...
        self.init_weights()
        self.casual_decoder_embeddings = None  #### additional attribute for user-specified decoder embedding lookup

    def set_casual_decoder_embeddings(self, embeds):  ####
        self.casual_decoder_embeddings = embeds

    def get_casual_decoder_embeddings(self):
        return self.casual_decoder_embeddings

    def casual_decoder_embeddings_exists(self):
        return not(self.casual_decoder_embeddings is None)
    ...
    def forward(
        ...
        output_hidden_states=None,
        return_dict=None,
        use_casual_decoder_embeddings=False,   #### whether use the casual decoder embedding instead of the normal input embedding
    ):
        r"""
        ...
        #### adding code for casual decoder embedding lookup
        if use_casual_decoder_embeddings:
            assert not (self.casual_decoder_embeddings is None)
            assert not (decoder_input_ids is None)
            assert decoder_inputs_embeds is None
            decoder_inputs_embeds = self.casual_decoder_embeddings(decoder_input_ids)
            decoder_input_ids = None
