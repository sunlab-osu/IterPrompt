...
g2 = open("eval_on_test_all_{}.sh".format(model_path.strip("/")), "w", encoding='utf-8')
g3 = open("eval_on_valid_all_{}.sh".format(model_path.strip("/")), "w", encoding='utf-8')
...
for checkpoint_step in all_checkpoint_steps:
    ...
    g2.write('python eval_qa.py --predict_file <location for saving prediction files>/{}predictions_test.txt'
             ' --eval_type qc\n'
             .format(model_path+path_suffix))

    g3.write('echo {}\n'.format(checkpoint_step))
    g3.write('python eval_qa.py --predict_file <location for saving prediction files>/{}predictions_valid.txt'
             ' --eval_type qc\n'
             .format(model_path + path_suffix))
