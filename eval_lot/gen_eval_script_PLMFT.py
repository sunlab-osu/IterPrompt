...
for checkpoint_step in all_checkpoint_steps:
    ...
    g2.write('python eval_qa.py --predict_file <location for saving prediction files>/{}predictions_valid.txt'
             ' --eval_type qc --eval_split valid --single\n'
             .format(model_path + path_suffix))

    g3.write('echo {}\n'.format(checkpoint_step))
    g3.write('python eval_qa.py --predict_file <location for saving prediction files>/{}predictions_test.txt'
             ' --eval_type qc --eval_split test --single\n'
             .format(model_path + path_suffix))
